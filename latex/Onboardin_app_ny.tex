...
% ========================================================================
% SLIDE 2: RISKFRÅGOR - MULTI-STEP WIZARD (5 steg)
% ========================================================================
% RiskfragorSlide i React (route: /riskfragor)
% Implementerad som multi-step wizard för bättre UX och progressiv datainsamling
% ========================================================================

% STEG 1/5: Företagsidentifikation & API-trigger
\begin{frame}[label=riskfragor-steg1]
  \frametitle{Riskfrågor – Steg 1 av 5: Företagsidentifikation}

  \begin{center}
    \textbf{Progress:} [●○○○○] Steg 1/5
  \end{center}
  ...
  \small
  \textbf{Bakgrund:}\\
  Penningtvättslagen (PTL) kräver att redovisningsbyråer fastställer varje kunds riskprofil. Tillsynsmyndigheten Länsstyrelsen Stockholm ställer tydliga krav på att byrån ska kunna visa att man förstått kundens affärsidé, verksamhetshistorik samt kund- och leverantörsstruktur.

  \vspace{0.5cm}

  \textbf{Organisationsnummer:}* \underline{\hspace{6cm}}
  \begin{block}{Format}
    \footnotesize XXXXXX-XXXX (t.ex. 556789-1234)
  \end{block}

  \vspace{0.3cm}

  \textbf{Personnummer (VD/Firmatecknare):}* \underline{\hspace{6cm}}
  \begin{block}{Format}
    \footnotesize YYYYMMDD-XXXX (t.ex. 19850315-1234)
  \end{block}

  \vspace{0.3cm}

  \textbf{Företagets registrerade namn:}* \underline{\hspace{6cm}}
  \begin{block}{Auto}
    \footnotesize Autofylls från Bolagsverket när org.nr är giltigt
  \end{block}

  \vspace{0.5cm}

  \begin{alertblock}{Vad händer när båda fält är ifyllda?}
    \footnotesize
    ⏳ Spinner visas: "Hämtar företagsinformation från Bolagsverket och Roaring.io..."\\
    📡 Backend anropar: \texttt{POST /api/onboarding/verify-identity}\\
    ✅ När klar: Autofyll av företagsnamn + aktivera "Nästa"-knapp
  \end{alertblock}
...
% STEG 2/5: Verksamhetsbeskrivning
\begin{frame}[label=riskfragor-steg2]
  \frametitle{Riskfrågor – Steg 2 av 5: Verksamhetsbeskrivning}

  \begin{center}
    \textbf{Progress:} [●●○○○] Steg 2/5
  \end{center}
  ...
  \textbf{1. Beskriv företagets huvudsakliga verksamhet:}*
  \begin{block}{Textarea}
    \tiny Placeholder: "Vad gör företaget? Vilka produkter/tjänster säljs?"
  \end{block}

  \vspace{0.3cm}

  \textbf{2. SNI-kod (branschkod):}* \underline{\hspace{7cm}}
  \begin{block}{Auto + Validering}
    \tiny Autofylls från Bolagsverket | Dropdown med sök | Kan ändras av användare\\
    ⚠️ \textbf{Varning visas vid avvikelse:} "Registrerad SNI hos Bolagsverket är '43.22 VVS-arbeten'. Du har valt '45.11 Bilhandel'. Detta kan indikera felaktig registrering."
  \end{block}

  \vspace{0.3cm}

  \textbf{3. Har verksamheten ändrats de senaste 12 månaderna?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  Om Ja → \underline{\hspace{6cm}} (Beskriv ändringen)
  \begin{block}{Risk}
    \tiny Plötslig verksamhetsändring = högrisk för penningtvätt
  \end{block}

  \vspace{0.3cm}

  \textbf{4. Bedriver företaget verksamhet från fast driftställe?}\\
...
% STEG 3/5: Kunder & Affärspartners
\begin{frame}[label=riskfragor-steg3]
  \frametitle{Riskfrågor – Steg 3 av 5: Kunder \& Affärspartners}

  \begin{center}
    \textbf{Progress:} [●●●○○] Steg 3/5
  \end{center}
  ...
  \textbf{1. Vilka typer av kunder har företaget?}*\\
  ☐ Privatpersoner (konsumenter) \hspace{0.5cm} ☐ Företag (B2B)\\
  ☐ Offentlig sektor \hspace{0.5cm} ☐ Välgörenhetsorganisationer/föreningar

  \vspace{0.3cm}

  \textbf{2. Geografisk marknad:}*\\
  ☐ Endast Sverige \hspace{0.5cm} ☐ Norden \hspace{0.5cm} ☐ EU \hspace{0.5cm} ☐ Utanför EU\\
  Om utanför EU → \underline{\hspace{6cm}} (Vilka länder?)
  \begin{block}{Risk}
    \tiny Högriskländer (FATF-listan) flaggas automatiskt av systemet
  \end{block}

  \vspace{0.3cm}

  \textbf{3. Har företaget återkommande affärspartners utanför Sverige?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  ...
  \textbf{4. Vilka är företagets tre största leverantörer?}\\
  ...
  \textbf{5. Vilka är företagets tre största kunder?} (om B2B)\\
  1. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  2. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  3. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}
...
\begin{frame}[label=riskfragor-steg4]
  ...
  \vspace{0.5cm}
  \begin{flushright}
    \hyperlink{riskfragor-steg3}{\beamerbutton{Tillbaka}} \hspace{0.3cm} \hyperlink{riskfragor-steg5}{\beamerbutton{Nästa}}
  \end{flushright}
\end{frame}

% STEG 5/5: PEP & Ägande
\begin{frame}[label=riskfragor-steg5]
  \frametitle{Riskfrågor – Steg 5 av 5: PEP \& Ägande}

  \begin{center}
    \textbf{Progress:} [●●●●●] Steg 5/5
  \end{center}
  ...
  \textbf{1. Vem/vilka är verkliga huvudmän (äger >25\%)?}*\\
  Ägare 1: \underline{\hspace{4cm}} Personnr: \underline{\hspace{3cm}} Andel: \underline{\hspace{1.5cm}}\\
  Ägare 2: \underline{\hspace{4cm}} Personnr: \underline{\hspace{3cm}} Andel: \underline{\hspace{1.5cm}}\\
  [+ Lägg till ägare]
  \begin{block}{Validering}
    \tiny Jämförs automatiskt med Roaring.io → Avvikelse flaggas
  \end{block}

  \vspace{0.3cm}

  \textbf{2. Är någon av följande personer en PEP?}*\\
  \tiny (Politiskt utsatt person = Personer i höga offentliga ämbeten: minister, riksdagsledamot, domare, generaldirektör, militär ledning, eller deras familjemedlemmar/nära medarbetare)\\
  \vspace{0.2cm}
  ☐ Ägare 1 \hspace{0.5cm} ☐ Ägare 2 \hspace{0.5cm} ☐ VD \hspace{0.5cm} ☐ Ingen\\
  Om Ja → Beskriv position och land: \underline{\hspace{5cm}}

  \vspace{0.3cm}

  \textbf{3. Har företaget kopplingar till sanktionerade länder eller personer?}\\
  ◯ Ja \hspace{0.3cm} ◯ Nej \hspace{0.3cm} ◯ Vet ej
  \begin{block}{Automatisk kontroll}
    \tiny Systemet kontrollerar automatiskt mot: EU-sanktionslistor, FN-sanktionslistor, OFAC (USA)
  \end{block}

  \vspace{0.3cm}

  \textbf{4. Finns det juridiska personer i ägarkedjan?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  Om Ja → Lista org.nr: \underline{\hspace{6cm}}
  \begin{block}{Risk}
    \tiny Komplexa ägarstrukturer = svårare att identifiera verkliga huvudmän
  \end{block}

  \vspace{0.3cm}

  \textbf{5. Är företaget noterat på börs?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej \hspace{0.5cm} Om Ja → Vilken börs? \underline{\hspace{3cm}}
  \begin{block}{Risk}
    \tiny Lägre risk om publikt bolag (redan granskat av Finansinspektionen)
  \end{block}
