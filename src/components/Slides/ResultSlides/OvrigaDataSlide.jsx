        ...
        {propertyData.properties.length > 0 && (
          <div className="mb-6 p-6 bg-brand-50 rounded-xl border border-brand-200">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3 bg-brand-100 rounded-lg border border-brand-300 text-center">
        ...
        <div className="mb-6 p-6 bg-white rounded-xl border border-brand-100">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            <div className="p-4 bg-brand-50 rounded-lg border border-brand-200 text-center">
              <div className="text-3xl font-bold text-brand-600">{engagementsData.currentEngagements}</div>
          ...
          {engagementsData.engagements.length > 0 && (
            <div className="space-y-2">
              ...
              {engagementsData.engagements.filter(e => e.status === 'Active').map((engagement, index) => (
                <div key={index} className="p-3 bg-white rounded-lg border border-brand-200 flex justify-between items-center">
                  <div>
