/**
 * StyrelseSlide_legacy.jsx
 * 
 * ORIGINAL VERSION FROM GITHUB - 2025-12-03
 * Denna använder mockRoaringData (den ursprungliga implementationen)
 * Sparad som referens för datastruktur.
 */

import React from 'react';
import { mockRoaringData } from '../../../data/mockRoaringData';

export default function StyrelseSlide_legacy({ onNext, onBack }) {
            ...
            <table className="w-full">
              ...
              <tbody>
                {boardData.board.map((member, index) => (
                  <tr key={index} className="border-b border-brand-100 hover:bg-brand-50 transition-colors">
