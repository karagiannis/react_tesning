      ...
      <div className="max-w-7xl w-full bg-white rounded-card shadow-2xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="p-4 bg-gray-50 rounded-box border border-gray-200">
            <div className="text-page-title text-gray-800">{summary.total}</div>
            <div className="text-sm text-gray-600">Flaggade poster</div>
          </div>
          <div className="p-4 bg-red-50 rounded-box border border-red-200">
            <div className="text-page-title text-red-800">{summary.errors}</div>
            <div className="text-sm text-red-600">Allvarliga avvikelser</div>
          </div>
          <div className="p-4 bg-yellow-50 rounded-box border border-yellow-200">
            <div className="text-page-title text-yellow-800">{summary.warnings}</div>
            <div className="text-sm text-yellow-600">Varningar</div>
          </div>
          <div className="p-4 bg-green-50 rounded-box border border-green-200">
            <div className="text-page-title text-green-800">{summary.ok.toLocaleString('sv-SE')}</div>
            <div className="text-sm text-green-600">Godkända</div>
          </div>
        </div>
        ...
        <div className="mb-8 overflow-hidden border border-brand-200 rounded-card">
          <table className="w-full">
            <thead className="bg-brand-100">
              <tr>
                <th className="py-3 px-4 text-left text-xs font-semibold text-brand-900 uppercase tracking-wider w-12">
                  Status
                </th>
                <th className="py-3 px-4 text-left text-xs font-semibold text-brand-900 uppercase tracking-wider w-24">
                  Ver.nr
                </th>
                <th className="py-3 px-4 text-left text-xs font-semibold text-brand-900 uppercase tracking-wider w-32">
                  Datum
                </th>
                <th className="py-3 px-4 text-left text-xs font-semibold text-brand-900 uppercase tracking-wider">
                  Beskrivning
                </th>
                <th className="py-3 px-4 text-right text-xs font-semibold text-brand-900 uppercase tracking-wider w-32">
                  Belopp
                </th>
                <th className="py-3 px-4 text-center text-xs font-semibold text-brand-900 uppercase tracking-wider w-24">
                  Skapad av
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {vouchers.map((voucher) => (
                ...
                >
                  ...
                  <td className="py-4 px-4 text-sm text-right font-semibold text-gray-800">
