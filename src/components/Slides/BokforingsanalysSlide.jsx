      ...
      <div className="max-w-7xl w-full bg-white rounded-2xl shadow-2xl p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-4 bg-green-50 rounded-lg border border-green-200">
            <div className="text-2xl font-bold text-green-800">{summary.ok.toLocaleString('sv-SE')}</div>
        ...
        {/* Rekommendation */}
        <div className="mb-8 p-6 bg-red-50 rounded-xl border-l-4 border-red-500">
