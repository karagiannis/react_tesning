    ...
    <div className="p-10">
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
          <div className="text-2xl font-bold text-green-600">{summary.ok.toLocaleString('sv-SE')}</div>
              ...
              >
                ...
                <td className="px-4 py-3 text-center">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      alert(`Öppnar verifikation ${voucher.id} med underlagspanel (TODO: Implementera)`);
                    }}
        ...
        >
          ...
          >
            ...
            <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex gap-3">
              <button
                onClick={() => setSelectedVoucher(null)}
                className="flex-1 px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors font-medium"
              >
                Stäng
              </button>
              <button
      ...
      <div className="flex justify-end mt-8">
        <button
          onClick={onNext}
          className="px-6 py-3 bg-brand-600 text-white font-medium rounded-lg hover:bg-brand-700 transition-colors shadow-md"
        >
...
function Step2_ReportArchive({ onNext, onBack }) {
  return (
    <div className="p-10">
      ...
      <p className="text-sm text-gray-500 bg-gray-50 p-4 rounded-lg mb-8">
        <strong>TODO:</strong> Implementera expanderbar mappstruktur med window.open() för PDF-rapporter.
      </p>
      <div className="flex justify-between mt-8">
        <button onClick={onBack} className="px-6 py-3 bg-gray-200 text-gray-700 font-medium rounded-lg hover:bg-gray-300 shadow-md transition-colors">
          ← Föregående
        </button>
        <button onClick={onNext} className="px-6 py-3 bg-brand-600 text-white font-medium rounded-lg hover:bg-brand-700 shadow-md transition-colors">
  ...
  return (
    <div className="p-10">
      ...
      <div className="flex justify-between mt-8">
        ...
        <button onClick={onFinish} className="px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 shadow-md transition-colors">
          ✓ Slutför Analys
        </button>
      </div>
    </div>
