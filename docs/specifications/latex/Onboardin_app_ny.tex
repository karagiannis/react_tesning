...
% (IntroSlide i React, route: /inledning) - FÖRSTA SLIDE MED SIDEBAR
...
\begin{frame}[label=intro]
  ...
  % UPPDRAGETS ART (kunden i centrum)
  \textbf{Vad kan vi hjälpa er med?}\\
  \vspace{0.3cm}
  Välj de tjänster ni är intresserade av:\\
  \vspace{0.2cm}
  
  ☐ Löpande bokföring\\
  ☐ Årsbokslut och årsredovisning\\
  ☐ Deklarationer (moms, arbetsgivaravgifter, inkomstdeklaration)\\
  ☐ Löneadministration\\
  ☐ Ekonomisk rådgivning och planering\\
  ☐ Företagsregistrering och bolagsbildning\\
  ☐ Finansiell rapportering och analys\\
  ☐ Rådgivning vid företagsförsäljning/succession\\
  ☐ Annat: \underline{\hspace{5cm}}
  
  \vspace{0.5cm}
  
  \begin{block}{Scenarion som leder hit}
    \footnotesize
    \textbf{Scenario 1:} Ni kontaktade oss och bokade onboarding – tack för förtroendet!\\
    \textbf{Scenario 2:} Vi träffades och ni var intresserade av att höra mer om våra tjänster.\\
    \vspace{0.2cm}
    I båda fallen börjar vi med \textit{era behov} – vad vill ni ha hjälp med?
  \end{block}
  
  \vspace{0.5cm}
  
  % DÄREFTER: Myndighetskrav (sekundärt)
  \begin{block}{Varför följer vi en strukturerad process?}
    \footnotesize
    Denna onboarding säkerställer att byrån uppfyller \textbf{penningtvättslagstiftningens krav} vid antagandet av nya kunder. Länsstyrelserna (tillsynsmyndigheten) har skärpt kraven och utfärdar sanktionsavgifter på hundratusentals kronor vid bristande efterlevnad.\\
    \vspace{0.2cm}
    Det är \textit{dessa myndighetskrav} som tvingar oss att ställa specifika frågor och spara dokumentationen i minst fem år. Processen syftar till att förebygga penningtvätt och ekonomisk brottslighet.
  \end{block}

  \vspace{0.8cm}
  \begin{flushright}
    \hyperlink{riskfragor-steg1}{\beamerbutton{Nästa}}
  \end{flushright}
...
\begin{frame}[label=riskfragor-steg1]
  ...
  \footnotesize
  \textbf{Bakgrund:}\\
  Penningtvättslagen (PTL) kräver att redovisningsbyråer fastställer varje kunds riskprofil. Tillsynsmyndigheten Länsstyrelsen Stockholm ställer tydliga krav på dokumentation.

  \vspace{0.4cm}

  % Affärsidé
  \textbf{1. Vad är företagets huvudsakliga affärsidé?}*
  ...
  \textbf{2. Vilka typer av kunder har företaget?}*\\
  \tiny
  ...
  % Utländska partners
  \textbf{3. Har företaget utländska affärspartners/kunder?}*
  \begin{block}{Textarea}
  ...
  % Leverantörer
  \textbf{4. Vilka är företagets största leverantörer?}*
  \begin{block}{Textarea}
  ...
  % Verksamhet ändrad
  \textbf{5. Har verksamheten ändrats under de senaste 12 månaderna?}*
  \begin{block}{Textarea}
  ...
  % Org.nr
  \textbf{6. Organisationsnummer:}* \underline{\hspace{4cm}}
  ...
  % Personnummer
  \textbf{7. Personnummer (VD/Firmatecknare):}* \underline{\hspace{4cm}}
  \begin{block}{Format \& API-trigger}
  ...
  \textbf{8. (Om juridisk person) Är det du som är verklig huvudman?}*\\
  \tiny
  ◯ Ja, jag äger/kontrollerar >25\% \hspace{0.5cm} ◯ Nej \hspace{0.5cm} ◯ Ej tillämpligt (enskild firma)
  \begin{block}{Lagtext: Lag (2017:631) om registrering av verkliga huvudmän}
    \tiny \textbf{1 kap. 3-6 §§:} En fysisk person som ensam eller tillsammans med annan ytterst äger eller kontrollerar juridisk person. Presumtion om kontroll vid >25\% röster (4§), rätt att utse/avsätta >50\% styrelse (4§), eller tillsammans med närstående (5§). För stiftelser: styrelseledamot eller den till vars förmån stiftelsen handlar (6§).
  \end{block}
  \begin{block}{Varför frågar vi?}
    \tiny Backend hämtar automatiskt verkliga huvudmän från Roaring.io (efter org.nr validering), men användarens egen bekräftelse är värdefull för att verifiera/komplettera registret. Om användaren svarar "Ja" kan vi flagga för manuell granskning om Roaring visar andra VH.
  \end{block}

  \vspace{0.2cm}

  % PEP
  \textbf{9. Är någon nyckelperson (VD/styrelse/ägare) politiskt exponerad person (PEP)?}*\\
  \tiny
  ☐ Ja, enligt PTL 1 kap 5§ (t.ex. riksdagsledamot, minister, diplomat, VD i statligt bolag)
  \begin{block}{Regulatoriskt krav}
    \tiny PTL kräver skärpt kontroll vid PEP (3 kap 10§)
  \end{block}
...
% ========================================================================
% RISKFRÅGOR - STEG 2 (FÖRDJUPADE FRÅGOR - CONDITIONAL)
% ========================================================================
% Dessa frågor visas ENDAST om specifika svar triggar dem från Steg 1
% Implementeras som conditional rendering i React baserat på formData
% ========================================================================

% MULTISTAGE 1: Utländska transaktioner (om "utländska partners" = Ja)
\begin{frame}[label=riskfragor-steg2]
  \frametitle{Riskfrågor – Steg 2 av 4: Utländska transaktioner}

  \begin{center}
    \textbf{Progress:} [●●○○] Steg 2/4\\
    \tiny \textit{Visas endast om: Användaren svarade "Ja" på "Utländska affärspartners/kunder" i Steg 1}
  \end{center}
  ...
  \textbf{1. Vilka länder har företaget affärspartners/kunder i?}*
  \begin{block}{Textarea + Dropdown}
    \tiny Dropdown med FATF-klassificering | Högriskländer flaggas automatiskt\\
    Exempel: Norge (Lågrisik), Ryssland (Högrisk), Nigeria (Högrisk)
  \end{block}

  \vspace{0.3cm}

  \textbf{2. Ungefär hur stor andel av omsättningen kommer från utländska kunder?}*\\
  Dropdown: [< 10\% / 10-30\% / 30-50\% / > 50\%]
  \begin{block}{Risk}
    \tiny >50\% från högriskländer = Enhanced Due Diligence (EDD) krävs
  \end{block}

  \vspace{0.3cm}

  \textbf{3. Bedriver företaget verksamhet från fast driftställe?}\\
  ◯ Ja \hspace{0.3cm} ◯ Nej \hspace{0.3cm} ◯ Hemmakontor\\
  Om Nej → \underline{\hspace{6cm}} (Beskriv var verksamheten bedrivs)
  \begin{block}{Risk}
    \tiny Ingen fast adress = svårare att kontrollera
  \end{block}
...
% STEG 3/4: Kunder & Affärspartners
\begin{frame}[label=riskfragor-steg3]
  \frametitle{Riskfrågor – Steg 3 av 4: Kunder \& Affärspartners}

  \begin{center}
    \textbf{Progress:} [●●●○] Steg 3/4\\
    \tiny \textit{Visas endast om: Användaren har utländska partners ELLER privatpersoner som kunder}
  \end{center}
  ...
  \textbf{1. Har företaget återkommande affärspartners utanför Sverige?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  ...
  \textbf{2. Vilka är företagets tre största leverantörer?}\\
  ...
  \begin{block}{Risk}
    \tiny Leverantörer från högriskländer flaggas
  \end{block}

  \vspace{0.3cm}

  \textbf{3. Vilka är företagets tre största kunder?} (om B2B)\\
  1. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  2. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  3. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}
...
% STEG 4/5: Betalningar & Transaktioner
\begin{frame}[label=riskfragor-steg4]
  \frametitle{Riskfrågor – Steg 4 av 5: Betalningar \& Transaktioner}

  \begin{center}
    \textbf{Progress:} [●●●●○] Steg 4/5
  \end{center}
  ...
  \textbf{1. Hur tar företaget betalt från kunder?}*\\
  ☐ Banköverföring/Swish \hspace{0.3cm} ☐ Kortbetalning \hspace{0.3cm} ☐ Faktura\\
  ☐ Kontanter \hspace{0.3cm} ☐ Kryptovaluta
  \begin{block}{Risk}
    \tiny Kontanter + Kryptovaluta = hög risk för penningtvätt
  \end{block}

  \vspace{0.3cm}

  \textbf{2. Om kontanter: Ungefär hur stor andel av omsättningen?}\\
  Dropdown: [< 5\% / 5-20\% / 20-50\% / > 50\%]
  \begin{alertblock}{Lagkrav}
    \tiny ⚠️ Kontanthantering över 20\% kräver tillstånd enligt Kontanthanteringslagen.\\
    Har företaget tillstånd från Skatteverket?
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{3. Förekommer transaktioner över 150 000 kr?}\\
  ◯ Ja \hspace{0.3cm} ◯ Nej \hspace{0.3cm} ◯ Ibland
  \begin{block}{Varför}
    \tiny PTL kräver förstärkt kundkännedom vid stora transaktioner
  \end{block}

  \vspace{0.3cm}

  \textbf{4. Tar företaget emot betalningar från tredje part?}\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  \tiny Exempel: Kund A betalar för Kund B:s tjänst
  \begin{block}{Risk}
    \tiny Högrisk för penningtvätt
  \end{block}

  \vspace{0.3cm}

  \textbf{5. Förekommer överföringar till/från utländska bankkonton?}\\
...
% }
%
% Backend endpoint: POST /api/onboarding/{id}/riskfragor/steg2
% Sparar ALLA KYC-svar från Steg 2-N i en enda request
% ========================================================================

% OBS: Steg 5/5 (PEP & Ägande) har tagits bort
% PEP-frågor finns i separat slide "PEP-Kontroll" efter Identitetskontroll + Kontrolltabell
