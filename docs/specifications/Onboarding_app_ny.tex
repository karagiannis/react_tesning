...
\begin{frame}[label=riskfragor-steg1]
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    \tiny  4 §   En verksamhetsutövare ska vidta åtgärder för kundkännedom vid etableringen av en 
    affärsförbindelse.\\
    ...
    \tiny \textbf{3 kap. 1 § första stycket PTL – Förbud mot affärsförbindelser och transaktioner}\\
    \tiny Otillräcklig kundkännedom\\

    \tiny 1 §   En verksamhetsutövare får inte etablera eller upprätthålla en affärsförbindelse 
    ...
    \tiny 3 §   En verksamhetsutövare ska bedöma den risk för penningtvätt eller finansiering av 
    ...
    \tiny 1 §   En verksamhetsutövare ska övervaka pågående affärsförbindelser och bedöma enstaka 
    ...
    \tiny 16 §   Om risken för penningtvätt eller finansiering av terrorism som kan förknippas med 
    ...
    \tiny \textbf{2 kap. 8 § första stycket PTL – Interna rutiner och riktlinjer}\\
    \tiny 8 §   En verksamhetsutövare ska ha dokumenterade rutiner och riktlinjer avseende sina åtgärder 
  ...
  \textbf{2. Vilka typer av kunder har företaget?}* \hspace{0.3cm} ⓘ\\
  \tiny
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    \tiny \textbf{4 kap. 1 § första stycket PTL – Övervaknings- och rapporteringsskyldighet}\\
  ...
  % Utländska partners
  \textbf{3. Har företaget utländska affärspartners/kunder?}* \hspace{0.3cm} ⓘ
  \begin{block}{Textarea}
    \tiny Om ja, vilka länder? Om nej, skriv "Nej"
  \end{block}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 11 § PTL – Kontroll av högriskländer}\\
    \tiny 11 §   En verksamhetsutövare ska kontrollera om kunden är etablerad i ett land utanför EES
     som av Europeiska kommissionen har identifierats som ett högrisktredjeland.\\[0.1cm]
    
    \tiny \textbf{Juridisk kommentar:}\\
    \tiny Redovisningsbyrån fungerar som outsourcad ekonomifunktion och ser alla klientens 
    transaktioner i bokföringen. När klienten handlar med utländska affärspartners blir dessa 
    transaktioner synliga för byrån. Enligt 3 kap. 12 § PTL måste byrån inhämta 
    information om "affärsförbindelsens syfte och avsedda karaktär", vilket inkluderar att 
    förstå var klientens affärspartners finns och varför transaktionerna sker. Om byrån ser 
    betalningar till högriskländer utan att förstå sammanhanget kan byrån göra sig skyldig 
    till näringspenningtvätt (Lag 2014:307 § 7).\\[0.1cm]
    
    \tiny \textbf{2 kap. 4 § PTL – Omständigheter som kan tyda på låg risk}\\
    \tiny 4 §   Som omständigheter som kan tyda på att risken för penningtvätt och finansiering av
     terrorism är låg kan verksamhetsutövaren beakta bland annat att kunden\\
    \tiny 1. är en stat, en region, en kommun eller motsvarande eller en juridisk person över vilken en stat,
     en region, en kommun eller motsvarande, var för sig eller tillsammans,
     har ett direkt eller indirekt rättsligt bestämmande inflytande,\\
    \tiny 2. har hemvist inom EES,\\
    \tiny 3. har hemvist i en stat som har bestämmelser om åtgärder mot penningtvätt
     och finansiering av terrorism som motsvarar dem i denna lag och som tillämpar
     dessa bestämmelser på ett effektivt sätt,\\
    \tiny 4. har hemvist i en stat som har en låg nivå av korruption och annan relevant brottslighet, och\\
    \tiny 5. är ett företag vars överlåtbara värdepapper är upptagna till handel på en reglerad
     marknad inom EES eller på en motsvarande marknad utanför EES. Lag (2019:980).
    \vspace{0.1cm}
    
    \tiny \textbf{2 kap. 5 § PTL – Omständigheter som kan tyda på hög risk}\\
    \tiny 5 §   Som omständigheter som kan tyda på att risken för penningtvätt eller finansiering av terrorism är hög kan verksamhetsutövaren beakta bland annat att
    \tiny 1. kundens ägarstruktur framstår som ovanlig eller alltför komplicerad för dess verksamhet,\\
    \tiny 2. kunden bedriver kontantintensiv verksamhet,\\
    \tiny 3. kunden är en juridisk person som har nominella aktieägare eller andelar utställda på innehavaren,\\
    \tiny 4. kunden är en juridisk person, en trust eller en liknande juridisk konstruktion som har till syfte 
     att förvalta en viss fysisk persons tillgångar,\\
    \tiny 5. kunden har hemvist i en stat som saknar effektiva system för bekämpning av penningtvätt
     eller finansiering av terrorism,\\
    \tiny 6. kunden har hemvist i en stat med betydande korruption och annan relevant brottslighet,\\
    \tiny 7. kunden har hemvist i en stat som är föremål för sanktioner, embargon eller liknande åtgärder,\\
    \tiny 8. kunden har hemvist i en stat som finansierar eller stöder terroristverksamhet
     eller där terroristorganisationer är verksamma,\\
    \tiny 9. affärsrelationer eller transaktioner sker på distans, utan användning av metoder som på ett 
     tillförlitligt sätt kan säkerställa kundens identitet, och\\
    \tiny 10. betalning av varor eller tjänster görs av någon som är okänd eller saknar koppling till kunden.
    \vspace{0.1cm}
    ...
    \tiny \textbf{01FS 2024:20, 3 kap. 8 § – Skärpta kundkännedomsåtgärder}\\
    \tiny 6 § Bestämmelser om skärpta åtgärder för kundkännedom finns i 3 kap. 16 och 17 §§ lagen (2017:630)
     om åtgärder mot penningtvätt och finansiering av terrorism.\\

    \tiny Allmänna råd\\
    \tiny Utöver vad som framgår av tabellen i 3 kap. 4 § dessa föreskrifter samt med hänsyn till vad
     som framgår av 3 kap. 16 § lagen (2017:630) om åtgärder mot penningtvätt och finansiering av
     terrorism och risken i den enskilda kundrelationen och övriga omständigheter kan skärpta
    åtgärder bland annat avse\\

    \tiny 1. fördjupad kontroll av kundens identitet, affärsverksamhet, ekonomiska situation och ekonomiska
     medel genom inhämtning av information om kunden och kundens historik från flera tillförlitliga
     och oberoende källor,\\
    \tiny 2. att inhämta ytterligare information om affärsförbindelsens eller den enstaka transaktionens
     avsedda syfte och art, genom att ställa fler frågor till kunden och kontrollera svaren,\\
    \tiny 3. ökad frekvens för uppdatering av kundkännedomsinformation, exempelvis så att
     informationen uppdateras flera gånger under ett år, eller\\
    \tiny 4. ökad frekvens och intensitet för granskning av transaktioner, exempelvis så att 
     granskning behöver göras oavsett belopp på transaktionen. För kunder som är etablerade 
     i ett land som har identifierats som ett högrisktredjeland av Europeiska kommissionen, 
     finns ytterligare krav på skärpta åtgärder i 3 kap. 17 § lagen (2017:630) om åtgärder mot 
     penningtvätt och finansiering av terrorism.
    \vspace{0.1cm}
    
    \tiny \textbf{EU-kommissionens lista över högriskländer}\\
    \tiny Europeiska kommissionen publicerar en officiell lista över högriskländer med strategiska
     brister i sina system mot penningtvätt och finansiering av terrorism. Detta är den juridiskt 
     bindande listan som svenska verksamhetsutövare måste följa enligt PTL. 
     Se aktuell lista på: \url{https://finance.ec.europa.eu/financial-crime/high-risk-third-countries_en}\\[0.1cm]
    ...
    \tiny Om ert företag har kunder i högriskländer påverkar det byråns riskbedömning av er som klient.
     ...
     och vilka åtgärder vi vidtagit för att hantera risken. 
     Detta är inte för att misstänkliggöra er - lagen tvingar oss att dokumentera detta 
     enligt 3 kap. 12 § PTL (information om affärsförbindelsens syfte och art).
  \end{alertblock}

  \vspace{0.2cm}

  % Leverantörer
  \textbf{4. Vilka är företagets största leverantörer?}* \hspace{0.3cm} ⓘ
  \begin{block}{Textarea}
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    Enligt 2 kap. 1 § måste byrån bedöma geografiska riskfaktorer, vilket inkluderar att 
  ...
  % Verksamhet ändrad
  \textbf{5. Har verksamheten ändrats under de senaste 12 månaderna?}* \hspace{0.3cm} ⓘ
  \begin{block}{Textarea}
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    \tiny \textbf{3 kap. 13 § första stycket PTL – Löpande uppföljning av affärsförbindelser}\\
    \tiny 13 §   En verksamhetsutövare ska löpande och vid behov följa upp pågående affärsförbindelser
    ...
    \tiny \textbf{4 kap. 1-3 §§ PTL – Övervaknings- och rapporteringsskyldighet}\\
    ...
    \tiny 2 §   Om avvikelser eller misstänkta aktiviteter eller transaktioner uppmärksammas
    ...
    \tiny 3 §   Om en verksamhetsutövare efter en bedömning enligt 2 § har skälig grund att 
  ...
  % Org.nr
  \textbf{6. Organisationsnummer:}* \underline{\hspace{4cm}} \hspace{0.3cm} ⓘ
  \begin{block}{Format \& API-trigger}
    \tiny XXXXXX-XXXX | När giltigt format anges → Backend anropar Bolagsverket API
  \end{block}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 7 §  PTL – Identifiering och kontroll av kunden}\\
    \tiny 7 §   En verksamhetsutövare ska identifiera kunden och kontrollera kundens identitet
    ...
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Organisationsnummer är grunden för identifiering av juridisk person enligt 3 kap. 7 § PTL. Vi måste kontrollera identiteten genom oberoende källor (Bolagsverket = offentligt register = tillförlitlig källa). Denna kontroll måste dokumenteras och sparas enligt 01FS 2024:20, oavsett om vi känner kunden sedan tidigare.
  \end{alertblock}

  \vspace{0.2cm}

  % Personnummer
  \textbf{7. Personnummer (VD/Firmatecknare):}* \underline{\hspace{4cm}} \hspace{0.3cm} ⓘ
  \begin{block}{Format \& API-trigger}
  ...
  \textbf{8. (Om juridisk person) Är det du som är verklig huvudman?}* \hspace{0.3cm} ⓘ\\
  \tiny
  ◯ Ja, jag äger/kontrollerar >25\% \hspace{0.5cm} ◯ Nej \hspace{0.5cm} ◯ Ej tillämpligt (enskild firma)
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 8 § första stycket PTL – Utredning av verklig huvudman}\\
    \tiny En verksamhetsutövare ska utreda om kunden har en verklig huvudman. En sådan utredning ska åtminstone avse sökning i registret över verkliga huvudmän enligt lagen (2017:631) om registrering av verkliga huvudmän. Om kunden är en juridisk person ska utredningen omfatta åtgärder för att \textbf{förstå kundens ägarförhållanden och kontrollstruktur}. Om kunden har en verklig huvudman, ska verksamhetsutövaren vidta åtgärder för att kontrollera den verkliga huvudmannens identitet.\\[0.1cm]
    
    \tiny \textbf{3 kap. 8 § tredje stycket PTL – Alternativ verklig huvudman}\\
    \tiny Om kunden är en juridisk person och det efter åtgärder står klart att den juridiska personen inte har en verklig huvudman, ska den person som är \textbf{styrelseordförande, verkställande direktör eller motsvarande befattningshavare} anses vara verklig huvudman.\\[0.1cm]
    
    \tiny \textbf{Lag (2017:631) 1 kap. 3 § – Definition av verklig huvudman}\\
    \tiny Med verklig huvudman avses:
    \begin{enumerate}
      \item en fysisk person som, ensam eller tillsammans med någon annan, \textbf{ytterst äger eller kontrollerar} en juridisk person, eller
      \item en fysisk person till vars förmån någon annan handlar.
    \end{enumerate}
    \vspace{0.1cm}
    
    \tiny \textbf{Lag (2017:631) 1 kap. 4 § – Presumtion om kontroll}\\
    \tiny En fysisk person ska antas utöva den yttersta kontrollen över en juridisk person, om han eller hon:
    \begin{enumerate}
      \item på grund av innehav av aktier, andra andelar eller medlemskap kontrollerar \textbf{mer än 25 procent} av det totala antalet röster i den juridiska personen,
      \item har rätt att utse eller avsätta \textbf{mer än hälften} av den juridiska personens styrelseledamöter eller motsvarande befattningshavare, eller
      \item på grund av avtal med ägare, medlem eller den juridiska personen, föreskrift i bolagsordning, bolagsavtal och därmed jämförbara handlingar, kan utöva kontroll enligt 1 eller 2.
    \end{enumerate}
    \vspace{0.1cm}
    
    \tiny Om en fysisk person ska antas utöva den yttersta kontrollen över en eller flera juridiska personer som utövar kontroll över en annan juridisk person på ett sätt som anges ovan, ska han eller hon antas utöva den yttersta kontrollen också över den senare juridiska personen (indirekt kontroll).\\[0.1cm]
  ...
  % PEP
  \textbf{9. Är någon nyckelperson (VD/styrelse/ägare) politiskt exponerad person (PEP)?}* \hspace{0.3cm} ⓘ\\
  \tiny
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    \tiny Person i politiskt utsatt ställning: fysisk person som har eller har haft en \textbf{viktig offentlig funktion} i en stat eller i en internationell organisation.\\[0.1cm]
    ...
    \begin{enumerate}
      \item stats- eller regeringschefer, ministrar samt vice och biträdande ministrar
      \item parlamentsledamöter och ledamöter av liknande lagstiftande organ
      \item ledamöter i styrelsen för politiska partier
      \item domare i högsta domstol, konstitutionell domstol eller andra rättsliga organ på hög nivå vilkas beslut endast undantagsvis kan överklagas
      \item högre tjänstemän vid revisionsmyndigheter och ledamöter i centralbankers styrande organ
      \item ambassadörer, beskickningschefer samt höga officerare i försvarsmakten
      \item personer som ingår i statsägda företags förvaltnings-, lednings- eller kontrollorgan
    \end{enumerate}
    \vspace{0.1cm}
    
    \tiny Med viktig offentlig funktion i en \textbf{internationell organisation} avses funktioner som direktörer, biträdande direktörer, styrelseledamöter och innehavare av liknande poster.\\[0.1cm]
    
    \tiny \textbf{1 kap. 10 § PTL – Familjemedlemmar och kända medarbetare}\\
    \tiny Med \textbf{familjemedlem} till en person i politiskt utsatt ställning avses make, registrerad partner, sambo, barn och deras makar, registrerade partner eller sambor samt föräldrar.\\[0.1cm]
    
    \tiny Med \textbf{känd medarbetare} avses:
    \begin{enumerate}
      \item fysisk person som gemensamt med en PEP är verklig huvudman till en juridisk person eller som på annat sätt har eller har haft nära förbindelser med en PEP
      \item fysisk person som ensam är verklig huvudman till en juridisk person som egentligen har upprättats till förmån för en PEP
    \end{enumerate}
    \vspace{0.1cm}
    ...
    \tiny Om kunden eller kundens verkliga huvudman är en person i politiskt utsatt ställning, ska en verksamhetsutövare utöver åtgärder enligt 7, 8 och 10-12 §§ alltid:
    \begin{enumerate}
      \item vidta lämpliga åtgärder för att \textbf{ta reda på varifrån de tillgångar} som hanteras inom ramen för affärsförbindelsen eller den enstaka transaktionen kommer
      \item tillämpa \textbf{skärpt fortlöpande uppföljning} av affärsförbindelsen och övervaka aktiviteter och transaktioner i förhöjd omfattning
      \item inhämta \textbf{godkännande från behörig beslutsfattare} inför beslut om att ingå eller avbryta en affärsförbindelse
    \end{enumerate}
    \vspace{0.1cm}
    
    \tiny Första stycket tillämpas också om kunden är en \textbf{familjemedlem eller känd medarbetare} till en person i politiskt utsatt ställning.\\[0.1cm]
    
    \tiny \textbf{3 kap. 20 § PTL – Efter upphörande av funktion}\\
    \tiny När en person i politiskt utsatt ställning upphör att utöva en offentlig funktion, ska 19 § tillämpas i \textbf{18 månader}. Därefter ska åtgärder enligt 19 § tillämpas om risken bedöms som hög.\\[0.1cm]
...
% Steg 2: Utländska transaktioner
\begin{frame}[label=riskfragor-steg2]
  \frametitle{Riskfrågor – Steg 2 av 4: Utländska transaktioner}

  \begin{center}
    \textbf{Progress:} [●●○○] Steg 2/4
  \end{center}
  ...
  \textbf{1. Vilka länder har företaget affärspartners/kunder i?}* \hspace{0.3cm} ⓘ
  \begin{block}{Textarea + Dropdown}
    \tiny Dropdown med FATF-klassificering | Högriskländer flaggas automatiskt\\
    Exempel: Norge (Lågrisk), Ryssland (Högrisk), Nigeria (Högrisk)
  \end{block}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 11 § PTL – Kontroll av högriskländer}\\
    \tiny En verksamhetsutövare ska kontrollera om kunden är etablerad i ett land utanför EES som av \textbf{Europeiska kommissionen} har identifierats som ett högrisktredjeland.\\[0.1cm]
    ...
    \tiny Åtgärderna ska i sådant fall kompletteras med de ytterligare åtgärder som krävs för att motverka den höga risken för penningtvätt eller finansiering av terrorism. Sådana åtgärder kan avse inhämtande av ytterligare information om kundens affärsverksamhet eller ekonomiska situation och uppgifter om varifrån kundens ekonomiska medel kommer.\\[0.1cm]
    
    \tiny \textbf{3 kap. 17 § första stycket PTL – Skärpta åtgärder vid högrisktredjeland}\\
    \tiny Skärpta åtgärder enligt 16 § ska vidtas vid affärsförbindelser eller enstaka transaktioner när kunden är etablerad i ett land utanför EES som har identifierats som ett högrisktredjeland av Europeiska kommissionen.\\[0.1cm]
    
    \tiny \textbf{FATF High-Risk Jurisdictions}\\
    \tiny Financial Action Task Force (FATF) publicerar listor över högriskländer med strategiska brister i sina system mot penningtvätt och finansiering av terrorism. EU-kommissionen baserar sin högrisklista delvis på FATF:s bedömningar. Aktuell FATF-lista: \url{https://www.fatf-gafi.org/en/countries/black-and-grey-lists.html}\\[0.1cm]
    
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Vi måste kontrollera om ert företags affärspartners är i högriskländer enligt 3 kap. 11 § PTL. Om ja, krävs skärpta åtgärder enligt 3 kap. 16 § och 3 kap. 17 §: ytterligare information om kundens affärsverksamhet och ekonomiska situation, uppgifter om varifrån kundens ekonomiska medel kommer, och särskilt omfattande kontroller. Detta är EU-kommissionens lista över högriskländer, baserat delvis på FATF:s bedömningar.
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{2. Typ av samarbete} \hspace{0.3cm} ⓘ\\
  ☐ Import \hspace{0.5cm} ☐ Export \hspace{0.5cm} ☐ Konsulttjänster \hspace{0.5cm} ☐ Licensavtal
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 12 § PTL – Information om affärsförbindelsens syfte och art}\\
    \tiny En verksamhetsutövare ska inhämta information om affärsförbindelsens syfte och art. Informationen ska ligga till grund för en bedömning av:
    \begin{enumerate}
    ...
    \tiny \textbf{3 kap. 1 § 1 st. PTL – Otillräcklig kundkännedom}\\
    \tiny En verksamhetsutövare får inte etablera eller upprätthålla en affärsförbindelse om verksamhetsutövaren inte har tillräcklig kännedom om kunden för att kunna hantera risken för penningtvätt eller finansiering av terrorism.\\[0.1cm]
    
    \tiny \textbf{3 kap. 16 § 1 st. PTL – Skärpta åtgärder vid hög risk}\\
    \tiny Olika samarbetsformer innebär olika risknivåer:
    \begin{itemize}
      \item \textbf{Import/Export:} Fysiska varor → risk för felaktig fakturering, under/överfakturering (trade-based money laundering)
      \item \textbf{Konsulttjänster:} Immateriella tjänster → svårare att värdera, risk för ogrundade betalningar
      \item \textbf{Licensavtal:} Royaltybetalningar → ofta gränsöverskridande, svår värdering, risk för överprissättning
    \end{itemize}
    \vspace{0.1cm}
    
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Vi måste förstå affärsförbindelsens syfte och art enligt 3 kap. 12 § PTL för att kunna bedöma vilka transaktioner som är normala för er verksamhet. Detta hjälper oss identifiera atypiska betalningsflöden som kan tyda på penningtvätt. Om samarbetsformen innebär hög risk (t.ex. konsulttjänster med svår värdering), krävs skärpta åtgärder enligt 3 kap. 16 § PTL.
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{3. Ungefär hur stor andel av omsättningen kommer från utländska kunder?}* \hspace{0.3cm} ⓘ\\
  Dropdown: [< 10\% / 10-30\% / 30-50\% / > 50\%]
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 12 § PTL – Information om affärsförbindelsens syfte och art}\\
    \tiny En verksamhetsutövare ska inhämta information om affärsförbindelsens syfte och art. Informationen ska ligga till grund för en bedömning av:
    \begin{enumerate}
    ...
    \tiny \textbf{3 kap. 16 § 1 st. PTL – Skärpta åtgärder vid hög risk}\\
    \tiny Om risken för penningtvätt eller finansiering av terrorism som kan förknippas med kundrelationen bedöms som hög, ska särskilt omfattande kontroller göras. Hög andel omsättning från högriskländer innebär förhöjd risk som kräver:
    \begin{itemize}
      \item Fördjupad granskning av affärsförbindelsen
      \item Dokumentation av medlens ursprung
      \item Ytterligare information om kundens affärsverksamhet och ekonomiska situation
      \item Ökad frekvens av löpande uppföljning
    \end{itemize}
    \vspace{0.1cm}
    
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Vi måste förstå omfattningen av era utländska affärer enligt 3 kap. 12 § PTL för att bedöma er riskprofil. Om en stor andel (>50\%) av omsättningen kommer från högriskländer, krävs skärpta åtgärder enligt 3 kap. 16 § PTL. Detta är inte för att misstänkliggöra er - lagen kräver att vi anpassar vår granskning baserat på riskbilden.
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{4. Tar företaget emot betalningar i utländsk valuta?} \hspace{0.3cm} ⓘ\\
  ◯ Ja \hspace{0.3cm} ◯ Nej\\
  Om Ja → Vilka valutor? \underline{\hspace{6cm}}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{4 kap. 1 § 1 st. PTL – Övervakningsskyldighet}\\
    \tiny En verksamhetsutövare ska övervaka pågående affärsförbindelser och bedöma enstaka transaktioner för att säkerställa att transaktioner som görs överensstämmer med den kännedom som verksamhetsutövaren har om kunden, kundens verksamhet och riskprofil.\\[0.1cm]
    
    \tiny \textbf{2 kap. 5 § punkt 5 PTL – Geografisk risk}\\
    \tiny Som omständigheter som kan tyda på att risken är hög kan verksamhetsutövaren beakta att kunden har hemvist i en stat som saknar effektiva system för bekämpning av penningtvätt. Betalningar i valutor från länder med svaga bankkontroller (även inom Europa) utgör förhöjd risk.\\[0.1cm]
    
    \tiny \textbf{3 kap. 16 § 1 st. PTL – Skärpta åtgärder vid hög risk}\\
    \tiny Om risken bedöms som hög ska särskilt omfattande kontroller göras, t.ex. inhämtande av ytterligare information om kundens affärsverksamhet eller ekonomiska situation och uppgifter om varifrån kundens ekonomiska medel kommer.\\[0.1cm]
    
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Vi måste övervaka att transaktioner överensstämmer med er verksamhet enligt 4 kap. 1 § PTL. Betalningar i valutor från länder med svaga bankkontroller (där banker inte ställer frågor om pengarnas ursprung) utgör förhöjd risk enligt 2 kap. 5 § punkt 5 PTL. Vi behöver veta vilka valutor som är normala för er verksamhet för att kunna identifiera avvikande transaktioner och vid behov tillämpa skärpta åtgärder enligt 3 kap. 16 § PTL.
  \end{alertblock}
  ...
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    ...
    \tiny \textbf{3 kap. 16 § 1 st. PTL – Skärpta åtgärder vid hög risk}\\
    \tiny Om risken för penningtvätt eller finansiering av terrorism som kan förknippas med kundrelationen bedöms som hög, ska särskilt omfattande kontroller göras. Transaktioner via banker i högriskländer eller länder med svaga AML-kontroller utgör förhöjd risk som kräver skärpta åtgärder.\\[0.1cm]
    
    \tiny \textbf{2 kap. 5 § punkt 5 PTL – Geografisk risk}\\
    \tiny Som omständigheter som kan tyda på att risken är hög kan verksamhetsutövaren beakta att kunden har hemvist i en stat som saknar effektiva system för bekämpning av penningtvätt. Utländska bankkonton i länder med svaga bankkontroller utgör förhöjd risk.\\[0.1cm]
    ...
    \tiny Utländska bankkonton kan användas för omvänd penningtvätt: vita pengar från Sverige överförs till utländskt konto för att dölja pengar, undvika skatt, eller betala svarta löner utomlands.\\[0.1cm]
    
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny Vi måste övervaka att transaktioner överensstämmer med er verksamhet enligt 4 kap. 1 § PTL. Utländska bankkonton utgör förhöjd risk för BÅDE traditionell penningtvätt (svarta pengar in till Sverige) OCH omvänd penningtvätt (vita pengar ut för att betala svarta kostnader utomlands). Om kontona finns i högriskländer krävs skärpta åtgärder enligt 3 kap. 16 § PTL.
  \end{alertblock}
...
% Steg 3: Kunder & Affärspartners
\begin{frame}[label=riskfragor-steg3]
  \frametitle{Riskfrågor – Steg 3 av 4: Kunder \& Affärspartners}

  \begin{center}
    \textbf{Progress:} [●●●○] Steg 3/4
  \end{center}
  ...
  \textbf{1. Har företaget återkommande affärspartners utanför Sverige?} \hspace{0.3cm} ⓘ\\
  ◯ Ja \hspace{0.5cm} ◯ Nej\\
  Om Ja → Beskriv: \underline{\hspace{6cm}}\\
  \tiny (Vilka länder? Typ av samarbete? Ungefär hur stor andel av omsättningen?)
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 13 § 1 st. PTL – Löpande uppföljning}\\
    \tiny Verksamhetsutövare ska vidta lämpliga åtgärder för att säkerställa att den kännedom som inhämtats i samband med kundkännedom hålls \textit{aktuell} och är tillräcklig.\\[0.1cm]
    \tiny \textbf{4 kap. 1 § 1 st. PTL – Övervakningsskyldighet}\\
    \tiny En verksamhetsutövare ska löpande övervaka att transaktioner som genomförs inom ramen för en affärsförbindelse överensstämmer med den kännedom som verksamhetsutövaren har om kunden, kundens verksamhet och riskprofil.\\[0.1cm]
    \tiny \textbf{3 kap. 12 § PTL – Information om affärsförbindelsens art}\\
    \tiny Vi ska inhämta information om affärsförbindelsens syfte och art, samt vilka transaktioner som kan \textit{förväntas} i förhållande till kundens verksamhet.\\[0.1cm]
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny För att göra en \textit{temporal riskbedömning}: Är era utländska affärspartners \textit{återkommande} (strukturella affärsrelationer) eller \textit{periodiska} (suspekta mönster vid vissa tidpunkter)? Om ni tidigare uppgav att 40\% av omsättningen kommer från utlandet, behöver vi förstå när detta mönster började för att avgöra om det är en naturlig del av verksamheten eller en nyligen uppkommen förändring. Detta är inte misstänksamhet – det är ett lagkrav på \textit{aktuell} kännedom (3 kap. 13 §).
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{2. Vilka är företagets tre största leverantörer?} \hspace{0.3cm} ⓘ\\
  1. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  2. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  3. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 12 § PTL – Information om affärsförbindelsens syfte och art}\\
    \tiny Vi ska inhämta information om affärsförbindelsens syfte och art, \textit{samt} information om vilka transaktioner som kan förväntas i förhållande till kundens verksamhet. Genom att be om \textit{de tre största} leverantörerna får vi en koncentrerad bild av var merparten av era inköp kommer ifrån, vilket är avgörande för att bedöma risk och betalningsflöden.\\[0.1cm]
    \tiny \textbf{PTL 2 kap. 2 § – Riskbaserat tillvägagångssätt}\\
    \tiny Verksamhetsutövaren ska bedöma och dokumentera de risker för penningtvätt som är förknippade med affärsförbindelsen.\\[0.1cm]
    \tiny \textbf{Röda flaggor – leverantörer:}\\
    \begin{itemize}
      \item Leverantörer i högriskländer (FATF-listan)
      \item Leverantörer utan tydlig affärsmodell
      \item Ovanligt stora leveranser från okända företag
      \item Betalningar till tredje part istället för till leverantören
      \item Priset avviker avsevärt från marknadspris (över-/underfakturering)
    \end{itemize}
    \vspace{0.1cm}
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny För att göra en \textit{progressiv verifikation}: I tidigare steg frågade vi generellt om ni har utländska leverantörer. Nu ber vi om \textit{konkreta namn och länder} för att verifiera konsistens och identifiera specifika risker kopplade till \textit{trade-based money laundering} (penningtvätt via handel). Om svaren här skiljer sig från era tidigare uppgifter, kan det tyda på bristande intern kontroll eller medveten vilseledning – båda situationer som kräver skärpta åtgärder enligt 3 kap. 16 § PTL.
  \end{alertblock}

  \vspace{0.3cm}

  \textbf{3. Vilka är företagets tre största kunder?} (om B2B) \hspace{0.3cm} ⓘ\\
  1. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  2. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}\\
  3. \underline{\hspace{5cm}} Land: \underline{\hspace{2cm}}
  \begin{alertblock}{Expansionsknapp (ⓘ) → Lagtext}
    \tiny \textbf{3 kap. 12 § PTL – Information om affärsförbindelsens syfte och art}\\
    \tiny Vi ska inhämta information om affärsförbindelsens syfte och art, samt information om vilka transaktioner som kan förväntas i förhållande till kundens verksamhet. Genom att be om \textit{de tre största} kunderna får vi en koncentrerad bild av var merparten av era intäkter kommer ifrån.\\[0.1cm]
    \tiny \textbf{PTL 3 kap. 1 § 1 st. – Förbud vid otillräcklig kundkännedom}\\
    \tiny En verksamhetsutövare får inte etablera en affärsförbindelse eller genomföra en transaktion om verksamhetsutövaren inte kan fullgöra de skyldigheter som följer av detta kapitel.\\[0.1cm]
    \tiny \textbf{3 kap. 16 § 1 st. PTL – Skärpta åtgärder vid hög risk}\\
    \tiny Om risken för penningtvätt eller finansiering av terrorism som kan förknippas med kundrelationen bedöms som hög, ska särskilt omfattande kontroller göras. Om huvudsakliga kunder är i högriskländer föreligger förhöjd risk som kräver skärpt kundkännedom.\\[0.1cm]
    \tiny \textbf{Varför frågar vi detta?}\\
    \tiny För att göra en \textit{progressiv verifikation och konsistenskontroll}: I tidigare steg frågade vi generellt om ni har utländska kunder. Nu ber vi om \textit{konkreta namn och länder} för era tre största kunder för att verifiera konsistens och bedöma om ni har exponering mot högriskländer eller koncentrationsrisk (beroende av enskilda aktörer). Om en eller flera av era största kunder är från tredje land med strategiska brister enligt FATF, eller om svaren här skiljer sig från era tidigare uppgifter, måste vi vidta skärpta åtgärder enligt 3 kap. 16 § PTL. Detta är inte misstänksamhet – det är verifiering av \textit{aktuell} kännedom som krävs enligt 3 kap. 13 § PTL.
  \end{alertblock}

  \vspace{0.5cm}
  \begin{flushright}
    \hyperlink{riskfragor-steg2}{\beamerbutton{Tillbaka}} \hspace{0.3cm} \hyperlink{riskfragor-steg4}{\beamerbutton{Nästa}}
  \end{flushright}
\end{frame}

% Steg 4: Betalningar & Transaktioner
\begin{frame}[label=riskfragor-steg4]
  \frametitle{Riskfrågor – Steg 4 av 4: Betalningar \& Transaktioner}

  \begin{center}
    \textbf{Progress:} [●●●●] Steg 4/4
  \end{center}
  ...
  \vspace{0.5cm}
  \begin{flushright}
    \hyperlink{riskfragor-steg3}{\beamerbutton{Tillbaka}} \hspace{0.3cm} \hyperlink{identitetskontroll}{\beamerbutton{Slutför \& Nästa}}
  \end{flushright}
\end{frame}
...
%   - Steg 1: Grundläggande information (RiskFragorSlide.jsx)
%   - Steg 2: Utländska transaktioner
%   - Steg 3: Kunder & Affärspartners
%   - Steg 4: Betalningar & Transaktioner
%
% Steg 5+: KONFIGURERBARA steg via config.json
%   - Byrån laddar ner config.json från Settings-sidan
%   - Lägger till custom riskfrågor i config
%   - Laddar upp uppdaterad config.json
%   - Extra steg visas automatiskt baserat på config
%
% Backend endpoints:
%   - POST /api/onboarding/{id}/riskfragor/steg1 - Sparar steg 1
%   - POST /api/onboarding/{id}/riskfragor/steg2 - Sparar steg 2
%   - POST /api/onboarding/{id}/riskfragor/steg3 - Sparar steg 3
%   - POST /api/onboarding/{id}/riskfragor/steg4 - Sparar steg 4
%   - POST /api/onboarding/{id}/riskfragor/custom - Sparar steg 5+ (från config)
%
% OBS: PEP-frågor finns i separat slide "PEP-Kontroll" efter Identitetskontroll
...
\begin{frame}[label=riskfragor-api]
  \frametitle{Backend API-endpoints för Riskfrågor}

  \footnotesize

  \textbf{Steg 1:} POST /api/onboarding/verify-identity\\
  \tiny → Anropar Roaring.io + Bolagsverket → Returnerar företagsnamn, SNI-kod, ägare

  \vspace{0.3cm}

  \textbf{Steg 2:} POST /api/onboarding/business-description\\
  \tiny → Sparar verksamhetsbeskrivning → Jämför SNI-kod med Bolagsverket → Flaggar avvikelser

  \vspace{0.3cm}

  \textbf{Steg 3:} POST /api/onboarding/business-relationships\\
  \tiny → Sparar kunder/leverantörer → Kontrollerar högriskländer (FATF-listan)

  \vspace{0.3cm}

  \textbf{Steg 4:} POST /api/onboarding/payment-methods\\
  \tiny → Sparar betalningsmetoder → Flaggar högrisk (kontanter >20\%, kryptovaluta)

  \vspace{0.3cm}

  \textbf{Steg 5:} POST /api/onboarding/ownership-pep\\
  \tiny → Sparar ägarstruktur → Jämför med Roaring.io → PEP-kontroll → Sanktionslistkontroll

  \vspace{0.5cm}

  \begin{alertblock}{Databas}
    \tiny All data sparas i \texttt{client\_onboarding\_data.csv} (eller PostgreSQL i production)\\
    Externa API-svar sparas i \texttt{roaring\_data.csv} och \texttt{bolagsverket\_data.csv}
  \end{alertblock}

  \vspace{0.3cm}

  \begin{block}{Korsvalidering}
    \tiny Backend jämför automatiskt klientens svar med officiell data från Roaring.io/Bolagsverket.\\
    Avvikelser sparas i \texttt{risk\_flags.csv} och visas senare i Riskbedömning-sliden.
  \end{block}
\end{frame}
