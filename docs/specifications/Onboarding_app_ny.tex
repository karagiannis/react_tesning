...
% Slide 11b: Penningflödesanalys med geografisk kartvisualisering (PenningflodesanalysSlide i React, route: /penningflodes)
\begin{frame}[label=penningflodes]
  ...
  \begin{block}{Fjärronboarding-läge}
    ...
    \vspace{0.2cm}
    När byråchefen är klar, skickas WebSocket-event: \texttt{forensic-review-complete} → Klienten fortsätter till Omsättningsanalys.
  \end{block}
  ...
  \vspace{0.5cm}
  \begin{flushright}
    \hyperlink{omsattning}{\beamerbutton{Nästa (Omsättningsanalys)}}
  \end{flushright}
\end{frame}
